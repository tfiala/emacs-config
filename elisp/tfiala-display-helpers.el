...
(when window-system
  ;; This hook ensures that frames default to solarized light, but
  ;; will respect the SOLARIZED environment variable to select dark if
  ;; specified.  It only makes sense when we're in windowed mode (gui).
